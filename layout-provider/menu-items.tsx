...
function MenuItems({
  ...
  return (
    <Sheet open={openMenuItems} onOpenChange={setOpenMenuItems}>
      <SheetContent
        side="right"
        className="w-80 sm:w-96 p-0 border-l shadow-xl rounded-tl-2xl flex flex-col"
        style={{
          top: topOffset,
      ...
      >
        {/* Header (fixed) */}
        <div className="bg-gradient-to-br from-indigo-600 via-indigo-500 to-sky-500 text-white px-6 py-6 shrink-0">
